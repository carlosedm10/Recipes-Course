...
class UserSerializer(serializers.ModelSerializer): # ModelSerializer is a serializer that converts the JSON data into a python object
    ...
    def update(self, instance, validated_data):
        ...
        password = validated_data.pop('password', None) # pop() removes the password from the validated data and sets it to None if it doesn't exist.
        user = super().update(instance, validated_data) # super() calls the ModelSerializer's update() function.
